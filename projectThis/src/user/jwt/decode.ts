...
import { DecodeResult, Session } from "../user";
//deserilize JWT-token into session object
//Denne funktion deserilize JWT-tokenen og varificerer at den ikke er blevet ændret undervejs.
